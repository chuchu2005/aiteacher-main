...
const Course = () => {
    ...
    }, [jsonData, mainTopic, messages, navigate, percentage, type]);
    ...
    return (
        <>
            {!mainTopic ? <></>
                :
                <div>
                  <div onClick={() => setIsOpenDrawer(true)} className="m-5 fixed bottom-4 left-4 z-40 w-12 h-12 bg-black text-white rounded-full flex justify-center items-center shadow-md dark:text-black dark:bg-white">
