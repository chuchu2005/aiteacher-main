                ...
                <div className='flex-1 flex items-center justify-center py-10 flex-col'>
                    <form onSubmit={handleSubmit} className="md:w-2/5 w-4/5 m-auto py-4 no-scrollbar ">
                        ...
                        <div className='py-6'>
                            ...
                            {sessionStorage.getItem('type') !== "free" ? (<Button onClick={redirectSubscription} className='my-6 items-center justify-center text-center border-black dark:border-white dark:bg-black dark:text-white bg-white text-black font-bold rounded-none w-full enabled:hover:bg-white enabled:focus:bg-white enabled:focus:ring-transparent dark:enabled:hover:bg-black dark:enabled:focus:bg-black dark:enabled:focus:ring-transparent'>Manage Subscriptions</Button>) : <></>}
                        </div>
