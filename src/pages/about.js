            ...
            <div className='dark:bg-black flex-1'>
                <div className='flex-1 flex flex-col items-center justify-center px-3'>
                    ...
                    <p className="text-center text-black mt-6 max-w-2xl font-medium max-md:text-xs dark:text-white">
                        Welcome to {name}, the cutting-edge Ai Teacher brought to you by {company}!
                    </p>
                </div>
                ...
                <div className='flex-1 flex flex-col items-center justify-center px-20 max-md:px-3'>
                    ...
                    <p className="text-black mb-2 mt-8 text-center max-md:text-xs dark:text-white">
                        Empowering educators, professionals, and organizations to create exceptional learning experiences effortlessly is at the heart of what we do. {name} embodies our commitment to leveraging AI technology to simplify the Learning process and unlock new realms of educational excellence.
